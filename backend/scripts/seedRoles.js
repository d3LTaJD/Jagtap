...
const rolesToSeed = [
  // Super Admin / SA / SUPER_ADMIN / superadmin
  {
    ...
    permissions: {
      ...
      Task:      { view: true, create: true, edit: true, delete: true, approve: true, assign: true }
    }
  },
  {
  ...
  // Technical Authority / TA / TECHNICAL_AUTHORITY
  {
    ...
    permissions: {
      ...
      Admin:     { view: true, create: false, edit: true, delete: false, approve: false, assign: false },
      Task:      { view: true, create: true, edit: true, delete: false, approve: false, assign: false }
    }
  },
  {
  ...
  // Management Viewer / MGR / MANAGEMENT_VIEWER
  {
    ...
    permissions: {
      ...
      Products:  { view: true, create: false, edit: false, delete: false, approve: false, assign: false },
      Admin:     { view: false, create: false, edit: false, delete: false, approve: false, assign: false },
      Task:      { view: true, create: false, edit: false, delete: false, approve: false, assign: false }
    }
  },
  {
